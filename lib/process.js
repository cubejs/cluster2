                ...
                self._heartbeatScheduler = self._heartbeatScheduler || setInterval(function () {
                    ...
                    var aggr = _.reduce(self._heartbeats, function(memoize, heartbeat){
                        return {
                            ...
                            usertime: (memoize.usertime || 0) + heartbeat.usertime,
                            systime: (memoize.systime || 0) + heartbeat.systime,
                            ...
                            fullGCs: (memoize.fullGCs || 0) + heartbeat.fullGCs,//sum
                            incrementalGCs: (memoize.incrementalGCs || 0) + heartbeat.incrementalGCs,//sum
                            heapCompactions: (memoize.heapCompactions || 0) + heartbeat.heapCompactions
                        };
                    }, {});
...
Process.prototype.listen = function() {
    ...
    if(cluster.isMaster) {
        ...
        var componentStatus = require('./component-status.js').componentStatus;
