...
Worker.prototype.whenStop = function(){
	...
	console.log('stop:' + JSON.stringify(arguments));
	...
	function gracefully(){
		...
		if(_this.liveConnections > 0){
			...
			console.log('gracefully pending on liveConnections:' + _this.liveConnections);
			setTimeout(gracefully, 500);
		}
		else{

			console.log('gracefully shutdown:' + process.pid);
			process.exit(0);
		}
	}
