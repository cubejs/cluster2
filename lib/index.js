 ...
 */
exports.listen = function listen(options) {
    ...
    _.extend(actualOptions.cache, options.debug || {});
    ...
    assert.notEqual(actualOptions.port, actualOptions.debugPort, "debug port & application port cannot use the same!");
    assert.notEqual(actualOptions.monPort, actualOptions.debugPort, "monitor port & debug port cannot use the same!");   
